---
name: mechanical-worker-standard
description: "Escalated standard variant of mechanical-worker. Use only after routing selected this role and tier. Performs exact, deterministic, reversible operations whose transformation is fully specified. Use for repetitive edits or data collection with no design decisions. Do not use for ambiguous implementation, diagnosis, review, or architecture."
